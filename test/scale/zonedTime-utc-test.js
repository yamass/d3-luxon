...
tape(`scaleZoned.nice(interval) nices using the specified time interval`, function(test) {
  ...
  test.deepEqual(x.nice(zonedTime.zonedDay("UTC")).domain(), [date.utc(2009, 0, 1), date.utc(2009, 0, 2)]);
  test.deepEqual(x.nice(zonedTime.zonedWeek("UTC", 7)).domain(), [date.utc(2008, 11, 28), date.utc(2009, 0, 4)]);
  test.deepEqual(x.nice(zonedTime.zonedMonth("UTC")).domain(), [date.utc(2008, 11, 1), date.utc(2009, 1, 1)]);
  test.deepEqual(x.nice(zonedTime.zonedYear("UTC")).domain(), [date.utc(2008, 0, 1), date.utc(2010, 0, 1)]);
  test.end();
});
...
tape(`scaleZoned.nice(interval.every(step)) nices using the specified time interval and step`, function(test) {
  var x = zonedTime.scaleZoned("UTC", 7).domain([date.utc(2009, 0, 1, 0, 12), date.utc(2009, 0, 1, 23, 48)]);
  test.deepEqual(x.nice(zonedTime.zonedDay("UTC").every(3)).domain(), [date.utc(2009, 0, 1), date.utc(2009, 0, 4)]);
  test.deepEqual(x.nice(zonedTime.zonedWeek("UTC", 7).every(2)).domain(), [date.utc(2008, 11, 21), date.utc(2009, 0, 4)]);
  test.deepEqual(x.nice(zonedTime.zonedMonth("UTC").every(3)).domain(), [date.utc(2008, 9, 1), date.utc(2009, 3, 1)]);
  test.deepEqual(x.nice(zonedTime.zonedYear("UTC").every(10)).domain(), [date.utc(2000, 0, 1), date.utc(2010, 0, 1)]);
  test.end();
});
...
tape(`scaleZoned.ticks(interval) observes the specified tick interval`, function(test) {
  ...
  test.deepEqual(x.ticks(zonedTime.zonedMinute("UTC")), [
...
tape(`scaleZoned.ticks(interval.every(step)) observes the specified tick interval and step`, function(test) {
  ...
  test.deepEqual(x.ticks(zonedTime.zonedMinute("UTC").every(10)), [
