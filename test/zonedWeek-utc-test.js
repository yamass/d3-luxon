...
tape("zonedWeek.floor(date) returns sundays", function(test) {
  ...
  test.deepEqual(time.zonedWeek(7, "UTC").floor(date.utc(2011, 00, 01, 23, 59, 59)), date.utc(2010, 11, 26));
  test.deepEqual(time.zonedWeek(7, "UTC").floor(date.utc(2011, 00, 02, 00, 00, 00)), date.utc(2011, 00, 02));
  test.deepEqual(time.zonedWeek(7, "UTC").floor(date.utc(2011, 00, 02, 00, 00, 01)), date.utc(2011, 00, 02));
  test.end();
});
...
tape("zonedWeek.ceil(date) returns sundays", function(test) {
  ...
  test.deepEqual(time.zonedWeek(7, "UTC").ceil(date.utc(2011, 00, 01, 23, 59, 59)), date.utc(2011, 00, 02));
  test.deepEqual(time.zonedWeek(7, "UTC").ceil(date.utc(2011, 00, 02, 00, 00, 00)), date.utc(2011, 00, 02));
  test.deepEqual(time.zonedWeek(7, "UTC").ceil(date.utc(2011, 00, 02, 00, 00, 01)), date.utc(2011, 00, 09));
  test.end();
});
